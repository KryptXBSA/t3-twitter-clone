    ...
    <div className="hidden h-screen xs:w-[88px] lg:block xl:w-[275px]">
      <div className="fixed flex h-screen w-[68px] flex-col overflow-y-auto xs:w-[88px] xl:w-[275px] xl:pr-3">
        ...
        <nav className="mt-5 ">
          ...
          <a
            className="font-sm mt-2 duration-350 mx-auto mb-10 flex h-11 w-11 items-center justify-center rounded-full bg-blue-400 py-3 font-bold text-white transition ease-in-out hover:bg-blue-500 xl:w-auto"
          >
