...
export default function Example() {
  let event = useEventContext();
  function onClick() {
    event.dispatchEvent("test", { data: "test" });
  }
  return (
    <NextLink href="">
      <div className="top-16 z-50 text-right">
        <Menu as="div" className="relative inline-block text-left">
          <Menu.Button onClick={onClick} className="hover-options flex  h-12 w-12 items-center justify-center  rounded-full ">
            <svg
